(() => {
  ...
  launcher.innerHTML = `<svg class="bottle-launcher-icon" viewBox="0 0 48 56" fill="none" aria-hidden="true">
    <g transform="rotate(14 24 28)">
      ...
      <path d="M18 10h12v11c0 3 9 5 9 12v13c0 4-3 6-7 6H16c-4 0-7-2-7-6V33c0-7 9-9 9-12V10Z" fill="#ffffff" fill-opacity=".04" stroke="#ffffff" stroke-width="2"/>
      <path d="M11 39c7-5 17 5 26 0v7c0 3-2 4-5 4H16c-3 0-5-1-5-4v-7Z" fill="#ffffff" fill-opacity=".08"/>
      ...
      <path d="M14 33v9M21 14v6" stroke="#ffffff" stroke-width="2" stroke-linecap="round" opacity=".75"/>
    </g>
